...
//    }
    ...
    */
    ...
    function theader(&$renderer,$name,$accesses='Accesses',$num="&nbsp;ランキング&nbsp;",$other="") {         
         ...
         $renderer->doc .= '<tr><th class="quickstats_sort" style="width:7em;">'. $num .'</th><th class="quickstats_sort">'.$name .'</th><th class="quickstats_sort" style="width:7em;">' . $accesses .'</th>';
         if($other) {
               $other = $js . $other .  '</a>';
